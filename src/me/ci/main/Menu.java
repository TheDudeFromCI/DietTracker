	...
	public Menu(){
		...
		addMouseMotionListener(new MouseAdapter(){
			...
			public void mouseMoved(MouseEvent e){
				...
				int x = e.getX();
				int y = e.getY();
				hover = x>=getWidth()-UNDO_BUTTON_EDGE_DISTANCE&&x<getWidth()-UNDO_BUTTON_EDGE_DISTANCE+30&&y>=getHeight()-UNDO_BUTTON_EDGE_DISTANCE
					&&y<getHeight()-UNDO_BUTTON_EDGE_DISTANCE+30;
				if(hover!=hoverBefore){
					repaint();
				}
			}
		});
